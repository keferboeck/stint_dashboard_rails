...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      h1: [/*64px*/ '3.75rem', { lineHeight: '4.125rem', letterSpacing: '0rem' }],
      h2: [/*56px*/ '2.875rem', { lineHeight: '3.375rem', letterSpacing: '0rem' }],
      h3: [/*40px*/ '2rem', { lineHeight: '2.25rem', letterSpacing: '0rem' }],
      h4: [/*36px*/ '1.75rem', { lineHeight: '2.25rem', letterSpacing: '0rem' }],
      h5: [/*36px*/ '1.35rem', { lineHeight: '2rem', letterSpacing: '0rem' }],
      h6: [/*36px*/ '1.125rem', { lineHeight: '1.625rem', letterSpacing: '0rem' }],
